...
st.set_page_config(page_title="WF4 \u2014 Quarterly Review", layout="wide")
...
# ── Header ────────────────────────────────────────────────────────────────────
st.title("WF4 \u2014 Quarterly Review")
st.caption(
    "Self-assessment \u00b7 Manager rating \u00b7 HR approval \u00b7 Performance record"
)
st.divider()
