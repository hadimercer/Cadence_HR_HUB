...
st.set_page_config(page_title="WF1 \u2014 KPI Dashboard", layout="wide")
...
st.title("WF1 \u2014 Workforce KPI Dashboard")
st.caption("Calculated from the most recent uploaded headcount snapshot")
st.divider()
